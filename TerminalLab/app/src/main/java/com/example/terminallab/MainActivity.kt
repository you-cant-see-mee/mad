...
class MainActivity : AppCompatActivity() {
    ...
    private fun logoutUser() {
        ...
        // For example, clearing session data, navigating to the login screen, etc.
        // For this example, let's just navigate to a hypothetical LoginActivity
        val intent = Intent(this, AuthActivity::class.java)
        // Clear the activity stack so the user can't go back to MainActivity without logging in again
